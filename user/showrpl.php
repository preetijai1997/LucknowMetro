...
<div class="zerogrid"  >
	...
	<div class="header">
		<div id='cssmenu' style="background-color:Red;">
			<ul>
			   ...
			   <li><a href='contact.php'><span>Complain</span></a></li>
		...
		<div id='cssmenu' style="background-color:Red;">
			<ul>
			   ...
			   <li><a href='ed.php' id="enq"><span>Enquery Details</span></a></li>
	...
	$cont=mysqli_connect("localhost","root","","contact");
	      $email=$_GET['email'];
		  $show="SELECT name,email,mob,subject,message FROM detail WHERE email='$email'";
	...
	?>
	    <tr>
															...
															color:black;font-size:30px;"><b>
															<?php echo $info['name'] ?></b></td></tr><td style=" margin-left:5px; margin-right:5px; padding:5px;">SUBJECT<b style="margin-left:12px">:</b><b style="margin-left:33px;"><?php echo $info['subject'] ?></b></td>
															<tr><td style=" align:left; margin-left:5px; margin-right:5px; padding:5px;">Enquery Message:</td></tr>
