...
<div class="zerogrid"  >
	...
	<div class="header">
		...
		<div id='cssmenu' style="background-color:Red;">
			<ul>
			   ...
			   <li><a href='#' id="enq"><span>Complain Details</span></a></li>
	...
	$cont=mysqli_connect("localhost","root","","contact");
		  $show="SELECT*FROM cmsg";
		  $enq=mysqli_query($cont,$show);
	?><center><div  id="e">
	<form method="post" action="">
	<h3 style="color:red">Complain Details<h3>
	</br>
	<table style="border-style: solid; border-width: 3px; border-color:red;" id="deta">
														...
														<th style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;" rowspan='1'>Photo</th>
														...
														<th style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;" rowspan='1'>Enquery Message</th>
	...
	?>
	    <tr>
															...
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:3px;"><img src="img.jpg" style="height:70px; width:45px;"></td>
	...
	<a href="creply.php?email=<?php echo $info['email']?>" <i style="color:blue">reply</i></a></button>
