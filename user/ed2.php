...
<div class="zerogrid"  >
	...
	?>
	  ...
	  ?>
		  	...
		  	<?php
		                          $cons=mysqli_connect("localhost","root","","contact");
				    					if(isset($_POST['rpl'])){
											$en=$_POST['en'];
											$email=$_GET['email'];
											$ms=$_POST['mst'];
											...
											$dt=$_POST['dt'];
											$mqr="INSERT INTO reply(email,adreply,name,sub,message,date)VALUES('$email','$ms','$en','$es','$message','$dt')";
											mysqli_query($cons,$mqr);
										}else{
