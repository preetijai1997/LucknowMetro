...
<div class="wrap-body">
	...
	<?php
							...
							$see="SELECT*FROM pset ORDER BY id DESC LIMIT 1";
	...
	<div class="header">
		<div id='cssmenu' style="background-color:red;">
			<ul>
			   ...
			   <li class="active"><a href='parking.php'><span>Parking</span></a></li>
				...
				<section class="content-box boxstyle-2 box-2">
					<div class="zerogrid">
						<div class="row wrap-box">
							...
							<div class="col-2-4">
						<h2 class="color-red" style="text-align:left;">Parking Charges</h2>
							<div class="wrap-col">
								<div class="contact">
									<div id="contact_form">
		...
		?>												<center>
															...
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['c6'] ?></td>
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['c12'] ?></td>
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['cm'] ?></td>
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['cd'] ?></td>
														</tr>
														...
														<tr>
															...
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['b6'] ?></td>
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['b12'] ?></td>
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['bc'] ?></td>
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['bm'] ?></td>
														</tr>
														...
														<tr>
															...
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['cy6'] ?></td>
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['cy12'] ?></td>
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['cyd'] ?></td>
															<td style="border:1px solid red; align:left; margin-left:5px; margin-right:5px; padding:5px;"><?php echo $row['cym'] ?></td>
														</tr>
						<?php
