...
<div class="zerogrid"  >
	...
	$cont=mysqli_connect("localhost","root","","contact");
	      $email=$_GET['email'];
		  $show="SELECT name,email,sub,msg FROM cmsg WHERE email='$email'";
	...
	?>
	    <tr>
															...
															<b>
															<?php echo $info['name'] ?></b></td></tr><td style=" margin-left:5px; margin-right:5px; padding:5px;">SUBJECT<b style="margin-left:12px">:</b><b style="margin-left:33px;"><?php echo $info['sub'] ?></b>
															</td>
															<tr><td style=" align:left; margin-left:5px; margin-right:5px; padding:5px;">Enquiry Message:
		...
		?>" style="display:none"></td></tr>
													...
													placeholder="Message"><?php echo $info['msg'] ?></textarea><tr><td style=" align:left; margin-left:5px; margin-right:5px; padding:5px;">Reply Message:</td></tr>
	  ...
	  <?php
		...
		if(isset($_POST['rpl'])){
		  ...
		  $date=$_POST['dt'];
		  $msg=$_POST['mst'];
		  $crp="INSERT INTO creply(email,date,mst) VALUES('$email','$date','$msg')";
		  mysqli_query($cont,$crp);
		  echo "message sent";
		}
		else{
