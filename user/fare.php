	...
	<div class="header">
		<div id='cssmenu' style="background-color:Red;">
			<ul>
			   ...
			   <li class="active"><a href='fare.php'><span>Fare</span></a></li>
					...
					<div class="wrap-content">
						<article>
							<div class="art-header">
								<h1 class="entry-title">L.M.T.Guide</h1>
							</div>
							...
							<div class="art-content">
								...
								<p>To know the fare between two stations, please select them from below:</p>
		...
		?>
							...
							<input type="submit" value="Show Fare" name="submit" style="margin:5px;width:250px;height:40px;color:white;background-color:red;border-radius:5px;font-family:max-height;font-size:15px;">
